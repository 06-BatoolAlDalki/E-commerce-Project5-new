<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_show_category1.aspx.cs" Inherits="project_5.product_show_category1" %>
<!DOCTYPE html>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0" style="color:#2B3467">
                        ...
                        <li class="nav-item"><a class="nav-link" href="category_page.aspx"style="color:#2B3467">Categories</a></li>
